...
const CommentRow = ({ comment }) => {
    return (
        ...
        <Link to={'/Feisbrut-React-Social/profile'} state={comment.authorId}><div className={styles.img} style={{ backgroundImage: `url(${comment.authorPhoto})` }}></div></Link>
            <div className={styles.comment}>
                <div className={styles.text}>
                <Link to={'/Feisbrut-React-Social/profile'} state={comment.authorId}>
